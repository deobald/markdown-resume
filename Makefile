...
build:
	pandoc -o resume.html --embed-resources --standalone --css=file://$(abspath resume-css-stylesheet-weasyprint.css) resume.md
	weasyprint -s file://$(abspath resume-css-stylesheet-weasyprint.css) resume.html resume.pdf
